...
<p>
  ...
  <%
		...
		ps=con.prepareStatement("select * from product where prod_id=6001");
  ...
  <tr>
    ...
    <td width="623" class="center1"><table width="466" height="200" border="0">
      <tr>
        ...
        <img src="${pageContext.request.contextPath}/resources/a.jpg"width="300" height="300" align="centre"> 
