...
<table width="993" height="102" border="0">
  <tr>
    ...
    <td width="726" class="right"></a> | <a href="main.jsp">Home</a> |
...
<p>
  ...
  <%
		...
		ps=con.prepareStatement("select * from product where prod_id=6007");
  ...
  <tr>
    ...
    <td width="623" class="center1"><table width="466" height="200" border="0">
      <tr>
        ...
        <img src="${pageContext.request.contextPath}/resources/image13.jpg"width="300" height="300" align="centre"> 
